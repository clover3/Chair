...
from trainer_v2.custom_loop.neural_network_def.var_local_decisions import BaselineNLI
...
def main(args):
    ...
    return tf_run(run_config, trainer, build_dataset)
