...
from trainer_v2.custom_loop.neural_network_def.segmented_enc import FuzzyLogicToMLP
from trainer_v2.custom_loop.neural_network_def.asymmetric2 import BERTEvenSegmentedWCallback
...
def main(args):
    ...
    def combine_fn():
        return FuzzyLogicToMLP(2, model_config.num_classes, run_config.train_config.train_step)
    inner: ClassificationModelIF = BERTEvenSegmentedWCallback(combine_fn)
