...
from trainer_v2.custom_loop.neural_network_def.contextualized import BERTAsymmetricContextualizedSlice4
...
@report_run3
def main(args):
    inner = BERTAsymmetricContextualizedSlice4(FuzzyLogicLayer)
