...
from trainer_v2.custom_loop.neural_network_def.contextualized import BERTAsymmetricContextualizedSlice
...
def main(args):
    ...
    inner = BERTAsymmetricContextualizedSlice(FuzzyLogicLayer)
