...
from trainer_v2.custom_loop.definitions import ModelConfig150_3
...
def run_classification_common(args, model_config):
...
@report_run3
def main(args):
    model_config = ModelConfig150_3()
    c_log.info("Start {}".format(__file__))
    run_classification_common(args, model_config)
