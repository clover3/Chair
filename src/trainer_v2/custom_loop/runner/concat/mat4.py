...
from trainer_v2.custom_loop.neural_network_def.combine_mat import MatrixCombine, MatrixCombine4
from trainer_v2.custom_loop.neural_network_def.two_seg_concat import TwoSegConcat, TwoSegConcat2
from trainer_v2.custom_loop.neural_network_def.var_local_decisions import NLC4, TSCVarLD
...
@report_run3
def main(args):
    c_log.info("Running {}".format(__file__))
    run_config: RunConfig2 = get_run_config2_nli(args)
    run_config.print_info()

    bert_params = load_bert_config(get_bert_config_path())
    model_config = NLC4()
    task_model = TSCVarLD(MatrixCombine4)
