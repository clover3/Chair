...
from trainer_v2.per_project.transparency.mmp.alignment.network.cls_pooling_pairwise import GAlignClsPoolingPairwise
...
class GAlignModel(ModelV3IF):
    ...
    def build_model(self, run_config):
        ...
        self.network = GAlignClsPoolingPairwise(tokenizer)
        loss_list = [
