...
from trainer_v2.per_project.transparency.mmp.term_effect_rankwise.path_helper import tfs_and_scores_path


def precompute_ranked_list(
        itr: Iterable[List[FourItem]], bm25: BM25) -> Iterable[List[Tuple[str, Counter, float]]]:
    n_item = 3000
...
def main():
    ...
    step_size = 100
    out_itr = precompute_ranked_list(g_itr, bm25)
    sub_no = 0
    ...
    def flush():
        ...
        save_path = tfs_and_scores_path(save_name)
