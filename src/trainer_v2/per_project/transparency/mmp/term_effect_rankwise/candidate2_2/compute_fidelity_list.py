...
def main():
    ...
    path_helper = get_cand2_2_list_path_helper()
    ...
    compute_save_fidelity_list_from_te(fidelity_fn, fidelity_save_dir, partition_list, qd_itr, te_save_dir)
