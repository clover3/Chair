...
def get_qd_scorer_model(encoder_model, max_seq_len) -> tf.keras.models.Model:
    ...
    # print(score)
    outputs = q_input_ids, d_input_ids
    print("This model returns q_input_ids, d_input_ids ")
...
def main(args):
    ...
    with strategy.scope():
        ...
        model: tf.keras.models.Model = get_qd_scorer_model(None, max_seq_len)
        prediction = model.predict(dataset, steps=1)

    q_input_ids, d_input_ids = prediction
