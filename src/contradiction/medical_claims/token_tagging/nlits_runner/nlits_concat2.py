...
from contradiction.medical_claims.token_tagging.solvers.nlits_batch_solver import get_batch_solver_nlits2
...
def main(args):
    def solver_factory(run_config, target_label):
        solver = get_batch_solver_nlits2(run_config, "concat", target_label)
        return solver
