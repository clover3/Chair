...
from data_generator.NLI.enlidef import CONTRADICTION
...
from contradiction.medical_claims.token_tagging.v2_solver_helper import solve_mismatch_ecc, solve_ecc
...
def main(args):
    ...
    def solver_factory(run_config, target_label):
        ...
        return solver
    solve_ecc(args, solver_factory, "conflict", CONTRADICTION)
