...
from contradiction.medical_claims.token_tagging.solvers.nlits_batch_solver import get_batch_solver_wmask
...
def main(args):
    ...
    def solver_factory(run_config, target_label):
        solver = get_batch_solver_wmask(run_config, "concat_wmask", target_label)
        return solver
