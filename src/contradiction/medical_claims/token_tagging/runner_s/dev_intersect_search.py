...
from contradiction.medical_claims.token_tagging.nli_interface import get_nli_cache_client, NLIInput
...
def main():
    ...
    sds = TreeDeletionSearch(cache_client.predict)
    for p in problem_list:
        ...
        def get_decision_res(t_text):
            logits = cache_client.predict([NLIInput(t_text, common)])[0]
