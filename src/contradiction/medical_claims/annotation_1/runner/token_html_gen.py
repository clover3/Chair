...
def main():
    num_review = 24
    html_template_path = os.path.join(data_path, "med_contradiction", "framenet", "annotation_template.html")
    html_out_root = at_output_dir("alamri_annotation1", "token_html")
