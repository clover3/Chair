...
def make_qcknc_problem(passage_score_path: FilePath,
    ...
    candidate_dict: Dict[int, List[Dict]] = dict(get_eval_candidates_from_pickle(split))
    ...
    candidate_id_dict_1: Dict[int, List[str]] = dict_value_map(get_pids, candidate_dict)
