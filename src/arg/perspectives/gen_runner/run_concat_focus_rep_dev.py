...
if __name__ == "__main__":
    def worker_factory(out_dir):
        ...
        rel_ex_score_dir = '/mnt/nfs/work3/youngwookim/data/bert_tf/pc_concat_rel_dev_ex'
    ...
    runner = JobRunner(sydney_working_dir, 696, "pc_concat_focus_rep_dev", worker_factory)
    runner.start()
