...
from tlm.training.classification_predict_model_fn import model_fn_classification
...
def main_inner(model_class=None):
    ...
    input_fn = input_fn_builder_classification_w_data_id(input_files, FLAGS, FLAGS.do_train)
