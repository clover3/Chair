...
from tlm.model.dual_bert_two_input import DualBertTwoInputWRel
from tlm.model_cnfig import JsonConfig
from tlm.training.classification_model_fn import model_fn_classification
from tlm.training.input_fn import input_fn_builder_two_inputs_w_rel
...
def main(_):
    ...
    model_fn = model_fn_classification(config, train_config, DualBertTwoInputWRel, special_flags)
    if FLAGS.do_predict:
