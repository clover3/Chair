...
from tlm.model.dual_bert_two_input import DualBertTwoInputIgnoreSecondModel
...
@report_run
def main(_):
    tf_logging.info("DualBertTwoInputIgnoreSecondModel")
    ...
    model_fn = model_fn_classification(config, train_config, DualBertTwoInputIgnoreSecondModel, special_flags)
    if FLAGS.do_predict:
