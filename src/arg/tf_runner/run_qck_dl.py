...
from tlm.model.model_two_input_ids import DualBertTwoInputWithDoubleInputLength
...
def main(_):
    ...
    model_fn = model_fn_classification(config, train_config, DualBertTwoInputWithDoubleInputLength, special_flags)
    if FLAGS.do_predict:
