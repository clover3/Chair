...
from tlm.model.multiple_evidence import ME5
...
from tlm.training.model_fn_binary_classification import model_fn_binary_classification_debug
...
def run_classification_w_second_input():
    ...
    model_fn = model_fn_binary_classification_debug(
        config,
        train_config,
        ME5,
    )
