...
from arg.qck.qck_dl_genenerator import QCKDoubleLengthInstanceGenerator
...
def main():
    ...
    candidate_dict = load_candidate_head_as_doc(512)
    generator = QCKDoubleLengthInstanceGenerator(candidate_dict, qrel.is_correct)
    num_jobs = 512
