...
def do_predict(bert_hp, train_config, data,
    ...
    output_d = predict_fn(sess, dev_batches[:20], lms_model.loss_tensor, lms_model.ex_score_tensor,
...
def main(start_model_path, modeling_option, num_gpu=1):
    ...
    output_d = do_predict(hp, train_config, data, LMSConfig(), modeling_option, init_fn)
