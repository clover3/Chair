...
from models.transformer.bert_common import gelu, get_activation, dropout, layer_norm, create_initializer, \
...
def transformer_model(input_tensor,
    ...
    ext_tensor = tf.get_variable("ext_tensor",
                                 shape=[mr_num_route, EXT_SIZE ,hidden_size],
                                 initializer=initializer,
                                 )
    ext_tensor_inter = tf.get_variable("ext_tensor_inter",
                ...
                if layer_idx == mr_key_layer:
                    with tf.variable_scope("mr_key"):
                        ...
                        if is_training:
                            ...
                            key = tf.math.argmax(key_output, axis=1)
