...
from data_generator2.segmented_enc.sent_split_by_spacy import split_spacy_tokens_no_mask
...
class SpacySplitWorker(IteratorWorkerSpec):
    ...
    def work(self, data_itr):
        ...
        for e in data_itr:
            text = e.hypothesis
            text_tuple = split_spacy_tokens_no_mask(self.nlp(e.hypothesis))
...
def main():
    ...
    name = "mnli_spacy_split_no_mask{}".format(split)
