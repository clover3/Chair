...
class FullTokenizerWarpper(object):
    def __init__(self, vocab_file, do_lower_case=True, cache_path= None):
        self.ft = FullTokenizer(vocab_file, do_lower_case, cache_path)
...
class FullTokenizer(object):
  ...
  def __init__(self, vocab_file, do_lower_case=True, cache_path= None):
    ...
    self.wordpiece_tokenizer = WordpieceTokenizer(vocab=self.vocab, cache_path=cache_path)
...
class WordpieceTokenizer(object):
  ...
  def __init__(self, vocab, cache_path = None, unk_token="[UNK]", max_input_chars_per_word=200):
    self.vocab = vocab
...
class EncoderUnit:
    def __init__(self, max_sequence, voca_path, cache_path = None):
        self.encoder = FullTokenizerWarpper(voca_path, cache_path)
