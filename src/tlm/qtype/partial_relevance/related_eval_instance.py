...
from bert_api.segmented_instance.segmented_text import text_to_word_level_segmented_text
...
def get_word_level_rei(e: TextPair, tokenizer) -> RelatedEvalInstance:
