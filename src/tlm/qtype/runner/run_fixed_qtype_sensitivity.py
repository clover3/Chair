...
from tlm.qtype.fixed_qtype_model_fn import model_fn_fixed_qtype_sensitivity, qtype_id_modeling_identity, process_feature
...
def main(_):
    ...
    model_fn = model_fn_fixed_qtype_sensitivity(FLAGS,
                                    process_feature,
