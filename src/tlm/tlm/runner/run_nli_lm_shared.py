...
from tlm.tlm.lm_nli_shared_model_fn import model_fn_nli_lm, input_fn_builder
...
def main(_):
    ...
    input_fn = input_fn_builder(input_files, FLAGS, is_training)
    model_fn = model_fn_nli_lm(config, train_config)
