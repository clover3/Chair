...
def alt_from_clueweb12_13A_100K():
    model_dir = pjoin(output_path, "models")
    nli_checkpoint = pjoin(pjoin(model_dir, "nli_bert_300_K"), "model.ckpt-73150")
    alt_emb_checkpoint = pjoin(pjoin(model_dir, "alt_emb_H"), "model.ckpt-100000")
    save_path = os.path.join(output_path, "models", "nli_alt_emb_H100K", "model.ckpt-73150")
    combine(nli_checkpoint, alt_emb_checkpoint, save_path)
