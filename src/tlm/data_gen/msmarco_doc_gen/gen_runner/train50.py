...
from tlm.data_gen.msmarco_doc_gen.processed_resource import ProcessedResource50doc

if __name__ == "__main__":
    split = "train"
    resource = ProcessedResource50doc(split)
    max_seq_length = 512
    ...
    runner = JobRunner(job_man_dir, len(resource.query_group)-1, "MMD_50doc_train_first".format(split), factory)
    runner.start()
