...
from tlm.data_gen.adhoc_datagen import FirstNoTitle
...
if __name__ == "__main__":
    ...
    max_seq_length = 512
    doc_rep_encoder = FirstNoTitle(max_seq_length)
    generator = GenerateFromTitleBody(resource, doc_rep_encoder, max_seq_length)

    def factory(out_dir):
        return MMDWorker(resource.query_group, generator, out_dir)

    runner = JobRunner(job_man_dir, len(resource.query_group)-1, "MMD_{}_first_no_title".format(split), factory)
    runner.start()