...
from tlm.data_gen.adhoc_datagen import FirstAndRandomTitleRepeat
from tlm.data_gen.msmarco_doc_gen.gen_worker import MMDWorker, PredictionTitleRepeatGen, \
    PointwiseGen, TitleRepeatFirstRandomGen
...
if __name__ == "__main__":
    ...
    max_seq_length = 512
    doc_rep_encoder = FirstAndRandomTitleRepeat(max_seq_length)
    generator = TitleRepeatFirstRandomGen(resource, doc_rep_encoder, max_seq_length)
