...
from dataset_specific.msmarco.common import load_candidate_doc_top50
...
if __name__ == "__main__":
    ...
    resource = ProcessedResourceTitleBodyTokensListTrain(split, load_candidate_doc_top50)
    qid_to_entity_tokens = get_qid_to_content_tokens(split)
    resource_path_format = os.path.join(job_man_dir, "MMD_2M_pred_parse", "{}")
    ...
    runner = JobRunnerS(job_man_dir, len(resource.query_group)-1, "MMD_{}_qe_de_distill2".format(split), factory)
    runner.start()
