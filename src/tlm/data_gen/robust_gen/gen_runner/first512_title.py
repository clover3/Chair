...
def main():
    ...
    worker_factory = partial(RobustWorker, RobustPointwiseTrainGenEx(encoder, max_seq_length, "title"))
    runner = JobRunner(job_man_dir, 4, "first_512_title", worker_factory)
    runner.start()
