...
from tlm.data_gen.adhoc_datagen import AllSegmentAsDoc, RobustPointwiseTrainGenEx
...
def main():
    ...
    runner = JobRunner(job_man_dir, 4, "robust_all_passage_pointwise_ex", worker_factory)
    runner.start()
