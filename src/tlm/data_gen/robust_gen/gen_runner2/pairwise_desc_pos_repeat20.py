...
def main():
    ...
    worker_factory = partial(RobustWorker,
                             RobustPairwiseTrainGen2(encoder, max_seq_length, "desc", 1000, "pos_major_repeat20_enum"))
    runner = JobRunner(job_man_dir, 4, "robust_pairwise_head_desc_pos_repeat20", worker_factory)
    runner.start()
